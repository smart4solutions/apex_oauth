...
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_GGL_API_KEY','AIzaSyBF926Tk5Q__ZC5H1fSUQSg7VOfJaiJo','Google API key  as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_GGL_CLIENT_ID','693589096014-9503r437up4otncmu96dc61jlp4nib.apps.googleusercontent.com','Google client ID  as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_GGL_CLIENT_SECRET','rwk7OkOQg-Fl_9NvFL9IZK','Google Client secret as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_GGL_REDIRECT_URL','http://www.yourdomain.com/ords/sepapex.s4sg_auth_pck.oauth2callback','The URL Google will redirect to');
...
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_LDI_CLIENT_ID','77uw6x8b02vz','Linked-in Client ID as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_LDI_CLIENT_SECRET','0TjdvCqUDBLKJ2','Linked-in Client Secret as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_LDI_REDIRECT_URL','http://www.yourdomain.com/ords/sepapex.s4sl_auth_pck.oauth2callback','Linked-in redirect URL');
...
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_FCB_CLIENT_ID','4392044057331','Facebook Client ID as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_FCB_CLIENT_SECRET','9f077058dc231a70f9df44db981e38','Facebook Client Secret as found in the developer console');
Insert into SEPAPEX.S4SA_SETTINGS (CODE,MEANING,DESCRIPTION) values ('S4SA_FCB_REDIRECT_URL','http://www.yourdomain.com/ords/sepapex.s4sf_auth_pck.oauth2callback','Facebook redirection URI');
